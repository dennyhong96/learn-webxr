...
class App {
  ...
  loadGLTF() {
    ...
    loader.load(
      ...
      (gltf) => {
        ...
        this.debugHelper(this.chair);
        this.scene.add(this.chair);
        this.progressBar.visible = false;
        this.renderer.setAnimationLoop(this.render.bind(this));
      },
      (xhr) => {
        this.progressBar.progress = xhr.loaded / xhr.total;
      },
      (err) => console.error("loadGLTF - An error happened", err)
    );
  }
  ...
  // Helper to debug object bounding box, to get a rough feel of the object scale
  debugHelper(object) {
